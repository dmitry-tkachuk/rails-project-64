...
class CommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create comment' do
    ...
    created_post_comment =
      PostComment.find_by(post_id: @root_comment.post_id,
  ...
  test 'should create nested comment' do
    post post_comments_path(@post), params: { post_comment: { content: @nested_comment.content,
                                                              parent_id: ActiveRecord::FixtureSet.identify(:root_comment1) } }

    created_post_comment =
      PostComment.find_by(post_id: @nested_comment.post_id,
